        ...
        <div class="left-sidebar-pro">
            <nav id="sidebar">
                <div class="sidebar-header">
                    <a href="#"><img src="../static/css/homeCSS/img/message/1.jpg" alt="" />
                    </a>
                    <h3>Andrar Son</h3>
                    <p>Developer</p>
                    <strong>AP+</strong>
                        ...
                        <div class="row">
                            <div class="col-lg-1 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="admin-logo logo-wrap-pro">
                                    <a href="#"><img src="../static/css/homeCSS/img/logo/log.png" alt="" />
                                    </a>
                                </div>
                            </div>
                                            ...
                                            <div role="menu" class="author-message-top dropdown-menu animated flipInX">
                                                ...
                                                <ul class="message-menu">
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="../static/css/homeCSS/img/message/1.jpg" alt="">
                                                            </div>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="../static/css/homeCSS/img/message/4.jpg" alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
                                                                <h2>Sulaiman din</h2>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="../static/css/homeCSS/img/message/3.jpg" alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
                                                                <h2>Victor Jara</h2>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="../static/css/homeCSS/img/message/2.jpg" alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
                                                                <h2>Victor Jara</h2>
                                                                ...
                                                                <ul class="notes-menu-list">
                                                                    <li>
                                                                        <a href="#">
                                                                            <div class="notes-list-flow">
                                                                                <div class="notes-img">
                                                                                    <img src="../static/css/homeCSS/img/notification/5.jpg" alt="" />
                                                                                </div>
                                                                    ...
                                                                    <li>
                                                                        <a href="#">
                                                                            <div class="notes-list-flow">
                                                                                <div class="notes-img">
                                                                                    <img src="../static/css/homeCSS/img/notification/1.jpg" alt="" />
                                                                                </div>
                                                                                <div class="notes-content">
                                                                                    <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                    <span>Yesterday 2:45 pm</span>
                                                                    ...
                                                                    <li>
                                                                        <a href="#">
                                                                            <div class="notes-list-flow">
                                                                                <div class="notes-img">
                                                                                    <img src="../static/css/homeCSS/img/notification/2.jpg" alt="" />
                                                                                </div>
                                                                                <div class="notes-content">
                                                                                    <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                    <span>Yesterday 2:45 pm</span>
                                                                    ...
                                                                    <li>
                                                                        <a href="#">
                                                                            <div class="notes-list-flow">
                                                                                <div class="notes-img">
                                                                                    <img src="../static/css/homeCSS/img/notification/3.jpg" alt="" />
                                                                                </div>
                                                                                <div class="notes-content">
                                                                                    <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                    <span>Yesterday 2:45 pm</span>
                                                                    ...
                                                                    <li>
                                                                        <a href="#">
                                                                            <div class="notes-list-flow">
                                                                                <div class="notes-img">
                                                                                    <img src="../static/css/homeCSS/img/notification/4.jpg" alt="" />
                                                                                </div>
                                                                                <div class="notes-content">
                                                                                    <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                    <span>Yesterday 2:45 pm</span>
                                                                    ...
                                                                    <li>
                                                                        <a href="#">
                                                                            <div class="notes-list-flow">
                                                                                <div class="notes-img">
                                                                                    <img src="../static/css/homeCSS/img/notification/6.jpg" alt="" />
                                                                                </div>
                                                                                <div class="notes-content">
                                                                                    <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                    <span>Yesterday 2:45 pm</span>
              ...
              <div class="modal-body">
                <form method="POST" action="update.php">
                    <div class="form-group"><center>
                      <label for="exampleInputPassword1">Update</label><br></center>
                      <input class="form-control" placeholder="Nama" name="nama" type="text"><br>
                      <input class="form-control" placeholder="Email" name="email" type="text"><br>
                      <input class="form-control" placeholder="Jabatan" name="jabatan" type="text"><br>
                      <input class="form-control" placeholder="Sub Area" name="subarea" type="text"><br>
                      <center><input type="submit" class="btn btn-success" value="Ubah Data">
                      <button type="button" class="btn btn-danger" data-dismiss="modal">Tutup</button></center>
                    </div>
                </form>
              </div>
           </div>
