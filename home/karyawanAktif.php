    ...
    <div class="wrapper-pro">
        ...
        <div class="sparkline8-graph">
            ...
            <div class="toolbar">
                    ...
                    $search_aktif = 'Aktif';
                    $query = "SELECT * FROM data_karyawan WHERE status1='$search_aktif' AND kbo LIKE ? AND kode_cc LIKE ?";
                ...
                ?>
                    <tr>
                        ...
                        <center><a title='Non Aktifkan Karyawan' href="<?php echo "nonAktif.php?nopeg=".$data['nopeg']; ?>"><i style="color: red" class="fas fa-user-times"></i></a></center> 
                        </td>                           
                    </tr>
                <?php } } else { ?> 
                    <tr>
