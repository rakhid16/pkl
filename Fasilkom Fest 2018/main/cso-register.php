...
<head>
  ...
  <script src="js/styles.cso.register.js"></script>
              ...
              <form class="col s12" id="loginForm">
                ...
                <div class="row">
                  <div class="input-field col s12">
                    ...
                    <font class="teal-text text-lighten-2" style="font-size: 12px">*email akan digunakan saat login</font>
                  </div>
                </div>
                <div class="row">
                  <div class="input-field col s12">
                ...
                <a class="waves-effect btn teal" onclick="validateRegister(1,2)">&nbsp;Next&nbsp;</a><br>
              </form>
            </div>
          </div>
        </div>
            ...
            <div class="row" style="margin: 30px 15px 20px 15px">
              <form class="col s12 ff-row" id="identitas-upload" style="padding-bottom: 20px !important">
                ...
                <div class="file-field input-field">
                  <img src="img/drag/drag-photo-cso.png" id="image-preview" class="file-field input-field" accept="image/*">
                  <br>
                  <div class="btn teal">
                    <span>FILE</span>
              ...
              <a class="waves-effect btn ff-theme" onclick="registerTo(1)">&nbsp;Back&nbsp;</a>
              <a class="waves-effect btn teal" onclick="validateRegister(2,3)">&nbsp;Next&nbsp;</a>
              <br>
            </div>
          </div>
        </div>
            ...
            <div class="row" style="margin: 30px 15px 20px 15px">
              <p align="left" style="margin-bottom: 30px;">
                <label>
                  ...
                  <span><a style="text-transform: none" class="teal-text">Data yang saya isi adalah benar</a></span>
                </label>
              </p>
              <a class="waves-effect btn ff-theme" onclick="registerTo(2)">&nbsp;Back&nbsp;</a>
              <a class="waves-effect btn teal" onclick="validateRegister(3,4)">&nbsp;Submit&nbsp;</a>
              <br>
            </div>
          </div>
        </div>
