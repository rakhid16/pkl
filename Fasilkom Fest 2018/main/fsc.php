      ...
      <div class="ff-header">
        ...
        <nav class="ff-navbar deep-purple darken-3 noselect">
          <a data-target="slide-out" class="ff-hamburger sidenav-trigger">
            ...
            <font class="ff-navbar-tittle">FSC 2018</font>
          </a>
          <div class="nav-wrapper">
            <ul class="ff-navbar-tittle-pc hide-on-med-and-down">
              <li><a onclick="location.reload()"><i><img src="img/logo/logo-fsc.png"></i>FSC 2018</a></li>
            </ul>
        ...
        <ul id="slide-out" class="sidenav noselect">
          <li><div class="user-view">
            ...
            <a><img class="circle" src="img/logo/logo-fsc.png"></a>
            <a><span class="white-text name">FSC 2018</span></a>
          ...
          <div class="row ff-row">
            <div class="col s12 l7 right noselect">
              <div class="ff-header-bg">
                <img src="img/header/header-fsc.png">
              </div>
            </div>
            <div class="col s10 offset-s1 l4 offset-l1">
              <p class="primary center">FSC 2018</p>
        ...
        <div class="row ff-row">
          ...
          <div class="col s12 m8 offset-m1">
            <p class="ff-about-desc">
              ...
              <b>FASILKOM FEST 2018</b> yang ditujukan bagi pelajar SMA / SMK / MA / MAK sederajat dan
