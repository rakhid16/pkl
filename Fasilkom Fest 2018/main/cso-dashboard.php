        ...
        <div class="ff-row row">
          ...
          <div class="dashboard-left-menu col s12 l4 ff-theme hoverable">
            <div class="dashboard-hi center">
              <a href="cso-dashboard"><img src="img/dashboard/dashboard-cso.png" class="logo"></a>
              <div class="secondary">
                  ...
                  <div class="col s12">
                    <div class="card ff-theme white-text hoverable">
                      <div class="card-content">
                        ...
                        <br>
                        <img src="img/poster/poster-cso.png" style="width: 100%" class="materialboxed" id="poster-value">
                        <br>
                      </div>
                    </div>
                  </div>
