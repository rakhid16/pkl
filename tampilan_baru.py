...
# Form implementation generated from reading ui file 'tampilan_baru(2).ui'
#
...
class Ui_MainWindow_utama(object):
    ...
    def setupUi_utama(self, MainWindow):
        ...
        spacerItem3 = QtWidgets.QSpacerItem(310, 17, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem3, 0, 0, 1, 1)
        self.pushButton_7 = QtWidgets.QPushButton(self.frame_3)
        self.pushButton_7.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/img/riwayat.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_7.setIcon(icon4)
        self.pushButton_7.setIconSize(QtCore.QSize(60, 55))
        self.pushButton_7.setObjectName("pushButton_7")
        self.gridLayout_2.addWidget(self.pushButton_7, 0, 1, 2, 1)
        ...
        query = "select Tanggal, 'NPM/NRP', Nama, Tanggal_Lahir, Usia, Golongan, Diagnosa, Perawatan_Gigi, Pengobatan FROM pengunjung"
