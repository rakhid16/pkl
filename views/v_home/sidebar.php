<div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item"> <a href="home/karyawan_aktif" role="button" aria-expanded="false" class="nav-link"><i class="fa big-icon fa-users"></i>&nbsp;&nbsp;<span class="mini-dn">Karyawan Aktif</span></a></li>
                        <li class="nav-item"> <a href="home/karyawan_nonaktif" role="button" aria-expanded="false" class="nav-link"><i class="fa big-icon fa-user-slash"></i>&nbsp;&nbsp;<span class="mini-dn">Karyawan Nonaktif</span></a></li>
